...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Res returned from login api: ", data);
    alert(data.message);
  ...
  return (
    <div className="LoginPage min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-white to-indigo-200 px-4">
